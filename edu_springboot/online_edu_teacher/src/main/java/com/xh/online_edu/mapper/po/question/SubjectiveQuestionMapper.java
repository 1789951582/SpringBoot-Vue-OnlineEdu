...
//import com.xh.online_edu_teacher.pojo.po.question.EduSubjectiveQuestion;
...
//
//@Mapper
//public interface SubjectiveQuestionMapper extends BaseMapper<EduSubjectiveQuestion> {
//    @Select("SELECT question_id,question,level,teacher_id " +
//            "FROM edu_subjective_question " +
