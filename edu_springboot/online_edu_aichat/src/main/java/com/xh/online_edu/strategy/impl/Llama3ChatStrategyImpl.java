...
@Component
public class Llama3ChatStrategyImpl extends BaseChatStrategyImpl{
    @Value("${chat.volcengine.apiKey}")
    private String apiKey;
    private String url="https://ark.cn-beijing.volces.com/api/v3/chat/completions";
    private final TokenBucketUtil tokenBucket=new TokenBucketUtil(120,2);

    @Override
    public ChatModel getChatModel() {
        return ChatModel.LLAMA3;
    }
    ...
    private RequestBody buildRequestBody(List<Message> msgList){
        ...
        map.put("stream",true);
        map.put("model","ep-20240928000024-2k78n");
        map.put("top_p",0.6);
        map.put("max_tokens",1024);
        map.put("presence_penalty",0.4);
